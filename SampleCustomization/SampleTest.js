...
monkey.config.anrSettings.fingerprintFunction = aFingerprintFunction;//false | aFingerprintFunction
...
monkey.config.anrSettings.eventsBetweenSnapshots = 600; //how often (in events) to take a snapshot using the fingerprintFunction 
